...
//定义唯一地址ID
#define		CC1101_UNIQUE_ADDR		0xAE
...
//两个通用引脚输出值
#define     GDO_LOW				0x1E						//查阅手册，0x1E保留,bit7 无用,bit6 判定输出高低电平					
#define     GDO_HIGH			0X5E						//输出高电平
...
void ReadRxFIFO(uint8_t *pBuffer,uint16_t len);
